...
const MyModal: FC<IMyModalProps> = ({ visible, setVisible, children, create }) => {
    ...
    return (
        <div className={rootClasses.join(' ')}>
            <div className='myModalContent' onClick={(e) => e.stopPropagation()}>
                ...
                <Button onClick={create} color="secondary" disabled={isFieldEmpty.some(isEmpty => isEmpty)}>Начать создание</Button>
            </div>
        </div>
    );
};
